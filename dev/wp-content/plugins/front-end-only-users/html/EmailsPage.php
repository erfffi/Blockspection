...
<p><strong>You can use the <a href='https://wordpress.org/plugins/ultimate-wp-mail/' target='_blank'>Ultimate WP Mail</a> plugin to create message using a visual builder instead of using the text editor below.</strong></p>

<p>If you're having trouble with sending emails, we recommend you use a plugin such as <a href='https://wordpress.org/plugins/wp-mail-smtp/'>WP Mail SMTP</a> to configure your SMTP settings.</p>
